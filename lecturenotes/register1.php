...
<?php
    $fnameErr=$lnameErr=$emailErr=$passErr=$rpassErr=$pass1Err=$userErr=$phoneErr="";
    ...
    if (!empty($_POST)) {
        ...
        if($status){
            ...
            $sql= "INSERT into registration (first_name,last_name,user_name,email,phone,password) values('$fname','$lname','$Uname','$email','$phone','$pass') ";
